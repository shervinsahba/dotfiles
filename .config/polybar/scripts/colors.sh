...
# if  [[ $1 = "-mode1" ]]; then
# # Replacing colors
# sed -i -e 's/bg = .*/bg = #2c0a0a0a/g' $PDIR/colors.ini     # translucent bar
# sed -i -e 's/fg = .*/fg = #f5f5f5/g' $PDIR/colors.ini       # text and inactive module icons
# sed -i -e 's/ac = .*/ac = #d26273/g' $PDIR/colors.ini		# workspace module
# sed -i -e 's/bi = .*/bi = #dc404040/g' $PDIR/colors.ini
# sed -i -e 's/be = .*/be = #dc404040/g' $PDIR/colors.ini
# sed -i -e 's/mb = .*/mb = #0a0a0a/g' $PDIR/colors.ini         # module blocks
# sed -i -e 's/mgf = .*/mgf = #0a0a0a/g' $PDIR/colors.ini       # module end caps
# sed -i -e 's/mf = .*/mf = #fdd835/g' $PDIR/colors.ini         # menu module, sys module
# # Restarting polybar
# $LAUNCH1 &
# $LAUNCH2 &
...
if  [[ $1 = "-mode1" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = #8c0a0a0a/g' $PDIR/colors.ini     # translucent bar
sed -i -e 's/fg = .*/fg = #f5f5f5/g' $PDIR/colors.ini       # text and inactive module icons
sed -i -e 's/ac = .*/ac = #d26273/g' $PDIR/colors.ini		# workspace module
sed -i -e 's/bi = .*/bi = #dc404040/g' $PDIR/colors.ini
sed -i -e 's/be = .*/be = #dc404040/g' $PDIR/colors.ini
...
# Replacing colors
sed -i -e 's/bg = .*/bg = #8c282a36/g' $PDIR/colors.ini  #gray or #44475 or #282a36 ?
sed -i -e 's/fg = .*/fg = #bd93f9/g' $PDIR/colors.ini  #purple
sed -i -e 's/ac = .*/ac = #ff79c6/g' $PDIR/colors.ini  #pink
sed -i -e 's/bi = .*/bi = #dc6272a4/g' $PDIR/colors.ini  #slate
sed -i -e 's/be = .*/be = #dc6272a4/g' $PDIR/colors.ini  #slate
sed -i -e 's/mb = .*/mb = #282a36/g' $PDIR/colors.ini  #gray
sed -i -e 's/mgf = .*/mgf = #282a36/g' $PDIR/colors.ini  #gray
sed -i -e 's/mf = .*/mf = #50fa7b/g' $PDIR/colors.ini  #green
# Restarting polybar
$LAUNCH1 &
$LAUNCH2 &

elif  [[ $1 = "-dracula2" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = #0a0a0a00/g' $PDIR/colors.ini  # translucent
sed -i -e 's/fg = .*/fg = #bd93f9/g' $PDIR/colors.ini  #purple
sed -i -e 's/ac = .*/ac = #ff79c6/g' $PDIR/colors.ini  #pink
sed -i -e 's/bi = .*/bi = #dc6272a4/g' $PDIR/colors.ini  #slate
sed -i -e 's/be = .*/be = #dc6272a4/g' $PDIR/colors.ini  #slate
sed -i -e 's/mb = .*/mb = #282b37/g' $PDIR/colors.ini  #gray
sed -i -e 's/mgf = .*/mgf = #282b37/g' $PDIR/colors.ini  #gray
sed -i -e 's/mf = .*/mf = #50fa7b/g' $PDIR/colors.ini  #green
# Restarting polybar
$LAUNCH1 &
$LAUNCH2 &
